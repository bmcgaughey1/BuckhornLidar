...
# 
# Code below is a brute force solution. I thought about computing an affine
# transformation using corner points (maybe others as well) but not sure this
# is the best approach. It may be best to keep the "perfect" grid (with additions)
# and relax the matching radius when assigning tree attributes to the lidar-derive
# tree locations.
#
...
# to best match the lidar-derived treetop locations. A key part of this is to 
# rotate around (1.8, 1.8) and not (0, 0). I can measure the correct angle for
# the rotation in ArcPro using Measure-Direction-Distance (gives azimuth).
#
columns <- 12
rows <- 26
spacing <- 3.6
...
if (blockNum == 1) {
  ...
  pts$Tag[49:60] <- c("10196","7681","2153","2076","2343","7522","5354","5477","6801","2307","2086","11342")
  ...
  pts$Tag[277:288] <- c("11493","6585","6534","7395","7368","9315","1138","66","6044","5034","5764","11393")
  ...
  pts$Tag[145:156] <- c("8417","3761","8303","4633","4678","4228","7517","7894","7801","7588","7579","10188")
  ...
  pts$Tag[217:228] <- c("11275","5263","296","4545","4585","6947","6535","7356","7469","4737","7436","11476")
  ...
  pts$Tag[265:276] <- c("2611","7817","8952","8993","1647","4326","3907","4008","4118","3780","4071","32698")
  ...
  pts$Tag[193:204] <- c("11216","4249","9201","8780","8302","4220","33205","1627","595","2439","11617","11515")
  ...
  pts$Tag[229:240] <- c("11324","5531","7072","403","2032","2289","5268","9257","2128","9134","6304","11267")
  ...
  pts$Live[makeIndex(26,43)] <- FALSE
  ...
  pts$Tag[13:24] <- c("11228","9203","8735","4132","8300","8861","6505","4414","2576","2535","7256","11543")
  ...
  pts$Tag[121:132] <- c("11655","827","59","1199","788","5186","8447","8717","8617","4056","3877","32644")
  pts$Tag[133:144] <- c("11658","5737","5213","5752","193","213","8554","8538","3778","4020","3867","32645")
...
block = data.frame(X = c(0, columns * spacing, columns * spacing, 0, 0),
                   Y = c(0, 0, rows * spacing, rows * spacing, 0))
